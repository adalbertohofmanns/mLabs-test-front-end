...
@font-face
  font-family: 'prime'
  src: local('prime'), url('./assets/fonts/prime_regular-webfont.ttf') format('ttf')
  src: local('prime'), url('./assets/fonts/prime_regular-webfont.woff') format('woff')
  font-weight: normal
  font-style: normal
